...
The file `src/TeamsNotificationBot/app-contract.json` serves as the shared interface between the Function App code and the Terraform infrastructure module. It is generated by `scripts/generate-contract.sh` and declares:
